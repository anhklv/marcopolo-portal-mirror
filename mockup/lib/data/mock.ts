...
export const events: Event[] = [
  ...
  },
  {
    ...
    description: "新年を祝う交流会。親睦を深めながら情報交換を行います。\n\n監査役協会とないかんMeetupの合同新年会です。監査役や内部監査人として活動されている皆様が一堂に会し、新年の抱負を語り合いながら、親睦を深める場です。異なる立場の方々との交流を通じて、新たな視点や気づきを得られる機会となることを期待しています。",
  ...
  },
  {
    ...
    description: "内部監査の最新動向について、専門家を招いてセミナーを開催します。\n\n内部監査の実務は日々進化しています。本セミナーでは、監査法人の内部監査部門で長年実務に携わってこられた専門家をお招きし、内部監査の最新動向についてお話しいただきます。\n\n特に、リスクベース監査の実践、データ分析を活用した監査手法、内部監査報告書の作成方法など、実務に直結する内容を扱います。",
    timetable: "13:30-14:00  受付\n14:00-14:10  開会挨拶\n14:10-15:40  講演「内部監査の最新動向と実践」\n15:40-16:00  休憩\n16:00-16:50  質疑応答・ディスカッション\n16:50-17:00  閉会挨拶",
    note: "会場の詳細な住所は参加確定後にお知らせいたします。\nセミナー資料は事前にPDFでお送りいたします。\nオンライン参加も可能です（Zoom）。\nCPE（継続専門教育）単位の申請を予定しています。",
    attendeesCount: 32,
