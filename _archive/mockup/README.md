...
仕様の詳細は `docs/` ディレクトリ内のドキュメントを参照してください。

- [要件定義書](../docs/要件定義書.md): 機能要件の詳細
- [画面設計書](../docs/画面設計書.md): 画面遷移図、UI構成要素
...
- **環境変数**: Dockerfileで `DOCS_DIR=/app/docs` が設定されており、Markdownファイルは `/app/docs` から読み込まれます
